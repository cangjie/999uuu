...
<script runat="server">
    ...
    {
        pArr = Product.GetHotProdByType(1);
    ...
    <form id="form1" runat="server">
        <div class="wrapper"  >
            ...
            <div class="channelnav">
                <p>当前位置：<a href="/">首页</a> &gt; <a href="#">出境游</a></p>
            </div>
            <div class="content">
                                        ...
                                        <tr bgcolor="#ffffff">
                                            <td height="26" valign="top">
                                                <table border="0" cellpadding="0" cellspacing="0" width="100%">
                                                    <tbody>
                                                        <tr>
                                                            <td align="center" background="images/t1.jpg" height="26" width="21%"><span class="bai">出境旅游经典推荐</span></td>
                                                            <td background="images/t2.jpg" width="72%">&nbsp;</td>
                                                            <td align="center" background="http://www.vipzzy.com/images/t2.jpg" width="7%"></td>
                                                        </tr>
                                                    </tbody>
                                                </table>
                                            </td>
                                                                                        ...
                                                                                        <tr bgcolor="#ffffff">
                                                                                            <td background="images/h2.gif" height="26" valign="top">
                                                                                                <table border="0" cellpadding="0" cellspacing="0" height="27" width="100%">
                                                                                                    <tbody>
                                                                                                        <tr>
                                                                                                            <td align="center" background="images/t1.jpg" height="24" width="21%"><span class="bai">国际特殊vip经典线路推荐</span></td>
                                                                                                            <td width="67%">&nbsp;</td>
                                                                                            ...
                                                                                            <td>
                                                                                                <table border="0" cellpadding="0" cellspacing="0" width="19%">
                                                                                                    <tbody>
                                                                                                        ...
                                                                                                        <tr>
                                                                                                            <td align="left"><span class="hong" style="color:#ff0000" >报价：¥ <%=pArr[i*2+16].RefPrice.ToString()%>元<%=((pArr[i*2+16].MultiPrice)?"起":"") %></span></td>
                                                                                                        </tr>
                                                                                                    </tbody>
                                                                                                </table>
                                                                                            </td>
